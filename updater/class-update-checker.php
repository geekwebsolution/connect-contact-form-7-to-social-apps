<?php
if (!class_exists('CF7CW_Update_Checker')) {

    class CF7CW_Update_Checker {
        ...
        public function check_for_updates($transient) {
            ...
            $transient_name = 'cf7cw_plugin_updates';
